  ...
  const handleSendNotification = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (dbError) {
        ...
        showDialog('Partial Success', 'The notification was broadcast to active users, but could not be saved to history. Please ensure the "notifications" table exists.', 'warning');
      } else {
        // Refresh history immediately after successful save
        fetchGlobalNotifications();
      }

      // 2. Use Supabase Realtime Broadcast for immediate delivery
